		...
		<div className="bg-white py-24 sm:py-32">
			<article className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl">
					...
					<h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl mt-4">
						{post.title}
					</h2>
					...
					<section
						key={post.id}
						className="flex max-w-xl flex-col items-start justify-between mt-4 sm:mt-8"
					>
						<div className="mt-5 text-gray-600 prose prose-sm">
							<p>{post.body}</p>
						</div>
						<div className="w-full flex items-center gap-x-4 mt-10 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16">
							<img
								alt=""
